<?php
/**
 * SETUP CHILD | 1.0.0 | 210816 | partials/taxonomy-profileset.php
 *
 * @package      Setup Child
 * @author       Mark Corpuz
 * @since        1.0.0
...
echo '<article class="module post-summary">';
	...
	echo '<div class="items info">';
		...
		// TITLE
		echo '<div class="text-xs"">partials/taxonomy-profileset.php</div>';
		//setup_child_title();
		//setup_link_title( get_the_ID() );
        setup_link_title_to_url( get_the_ID() );
        setup_link_list_taxonomy( get_the_ID(), 'profileset' );
